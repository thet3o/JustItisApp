    ...
    return Scaffold(
          ...
          children: [
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => const SubMenu(
                                    categories: [IngredientCategory.bevande])));
                      },
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Image.asset(
                            'assets/menu/soft-drink.png',
                            scale: 3.5,
                          ),
                          const Text('Bevande')
                        ],
            ...
            Row(
              ...
              children: [
                Card(
                    color:
                        Colors.grey, //const Color.fromARGB(255, 255, 164, 27),
                    elevation: 10,
                    shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(10)),
                    child: InkWell(
                      onTap: () {
                        ...
                        //        builder: (context) => const SubMenu(
                        //                categories: [
                        //                  IngredientCategory.prodottoDelGiorno
                        //                ])));
                      },
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                ...
                Card(
                    ...
                    child: InkWell(
                      onTap: () {
                        ...
                        //    MaterialPageRoute(
                        //        builder: (context) => const SubMenu(
                        //            categories: [IngredientCategory.snack])));
                      },
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Image.asset(
                            'assets/menu/snack.png',
                            scale: 3.5,
                            color: Colors.grey,
                            colorBlendMode: BlendMode.saturation,
                          ),
      ...
      floatingActionButton: (cart.isNotEmpty)
          ? FloatingActionButton.extended(
              ...
              label: Text('${cart.length} Completa l\'ordine'))
          : null,
    );
  }
}
